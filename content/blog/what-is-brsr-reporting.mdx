...
The BRSR framework requires disclosure across multiple dimensions that align with the [GHG Protocol](https://ghgprotocol.org/corporate-standard) and international standards. Understanding these reporting categories is essential for compliance and effective data management.
...
Companies should use the [GHG Protocol Corporate Accounting and Reporting Standard](https://ghgprotocol.org/corporate-standard) as the basis for emissions calculations. SEBI provides detailed guidance on conversion factors and methodologies specific to India's electricity grid mix and fuel characteristics.
