...
description: "What is a carbon footprint for a business? Complete guide covering Scope 1, 2, and 3 definitions, how companies measure their emissions, and first steps toward a credible reduction target."
date: "2026-04-05"
author: "Greenio"
level: 1
...
**Regulatory compliance** - Mandatory disclosure requirements across major markets now require quantified emissions data. The EU's CSRD, UK's SECR, India's BRSR, and the [GHG Protocol](https://ghgprotocol.org/corporate-standard) set clear standards.
...
For detailed guidance on calculating each scope, see: [How to Calculate Scope 1 Emissions](/blog/how-to-calculate-scope-1-emissions), [How to Calculate Scope 2 Emissions](/blog/how-to-calculate-scope-2-emissions), and [How to Calculate Scope 3 Emissions](/blog/how-to-calculate-scope-3-emissions).
