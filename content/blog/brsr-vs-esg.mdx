...
**ESG** is governed by market-driven initiatives - there is no single authority. Major frameworks include GRI (Global Reporting Initiative), SASB (Sustainability Accounting Standards Board), TCFD ([Task Force on Climate-related Financial Disclosures](https://www.fsb-tcfd.org/)), and others.
