...
description: "ESG reporting vs carbon accounting: what each covers, how they overlap, and why sustainability managers need both - not one or the other - to meet investor and regulatory expectations."
date: "2026-04-01"
author: "Greenio"
level: 3
...
Multiple frameworks guide ESG reporting, including the Sustainability Accounting Standards Board (SASB), the Global Reporting Initiative (GRI), and the [Task Force on Climate-related Financial Disclosures](https://www.ifrs.org/groups/task-force-on-climate-related-financial-disclosures/) (TCFD). Each framework offers different guidance on materiality assessment, disclosure standards, and stakeholder engagement.
