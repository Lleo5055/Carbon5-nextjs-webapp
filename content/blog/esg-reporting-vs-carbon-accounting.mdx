...
Multiple frameworks guide ESG reporting, including the Sustainability Accounting Standards Board (SASB), the Global Reporting Initiative (GRI), and the [Task Force on Climate-related Financial Disclosures](https://www.fsb-tcfd.org/) (TCFD). Each framework offers different guidance on materiality assessment, disclosure standards, and stakeholder engagement.
