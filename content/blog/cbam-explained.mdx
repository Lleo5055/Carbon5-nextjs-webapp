...
description: "CBAM explained: which goods are in scope, how to calculate embedded carbon, what EU importers must declare, and how Indian and Chinese exporters can prepare for charges from 2026."
date: "2026-04-03"
author: "Greenio"
level: 3
...
CBAM creates a level playing field by requiring importers to purchase CBAM certificates reflecting the carbon content of their goods. The mechanism is directly linked to the [EU Emissions Trading System](https://climate.ec.europa.eu/eu-action/eu-emissions-trading-system-eu-ets_en) (ETS), which has set the gold standard for carbon pricing in Europe for over two decades. Read more about how this fits into the broader EU climate architecture in our guide on [EU ETS Explained](/blog/eu-ets-explained).
...
<BlogCTA country="Europe" locale="en" regulation="[CSRD](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:32022L2464)" />
