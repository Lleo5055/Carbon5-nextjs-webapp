...
description: "How to calculate Scope 3 emissions: which of the 15 categories are likely material, what data to collect for each, spend-based vs activity-based approaches, and how to prioritise your largest sources."
date: "2026-03-30"
author: "Greenio"
level: 3
...
This guide walks you through all 15 [GHG Protocol](https://ghgprotocol.org/corporate-standard) Scope 3 categories and provides practical calculation methods to help you quantify and manage these critical emissions.
