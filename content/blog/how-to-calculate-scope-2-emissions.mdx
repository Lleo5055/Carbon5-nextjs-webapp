...
Scope 2 emissions represent the indirect greenhouse gas emissions from the electricity, steam, heating, and cooling that your business purchases from external sources. Unlike Scope 1 emissions, which come directly from your own operations, Scope 2 emissions occur at the power generation facility - but your organization is responsible for reporting them under the [GHG Protocol](https://ghgprotocol.org/corporate-standard).
...
The answer lies in standardized methodologies. The GHG Protocol, which forms the foundation for BRSR, [SECR](https://www.gov.uk/government/collections/streamlined-energy-and-carbon-reporting), and CSRD, provides two calculation methods. Getting this right ensures your carbon reporting is credible and compliant with stakeholder expectations.
