...
description: "SBTi explained: how science-based targets work, the difference between near-term and net-zero targets, which validation pathway applies to your sector, and what companies must do to get targets approved."
date: "2026-04-03"
author: "Greenio"
level: 3
...
The [Science Based Targets initiative](https://sciencebasedtargets.org) (SBTi) has become the gold standard for corporate climate ambition. In 2026, setting science-based targets is no longer a nice-to-have - it's increasingly expected by investors, regulators, customers, and employees. But what exactly is SBTi, and how do you develop targets that will pass validation? This guide walks you through everything you need to know.
