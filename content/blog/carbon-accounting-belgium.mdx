...
description: "Carbon accounting in Belgium: CSRD reporting obligations for Belgian companies, key emission sources across manufacturing, chemicals, and financial services, and practical steps to prepare for 2026."
date: "2026-03-29"
author: "Greenio"
level: 2
...
Carbon accounting is the systematic measurement and tracking of greenhouse gas (GHG) emissions across your operations. The [What is Carbon Accounting?](/blog/what-is-carbon-accounting) guide covers the [GHG Protocol](https://ghgprotocol.org/corporate-standard) framework, which CSRD aligns with.
