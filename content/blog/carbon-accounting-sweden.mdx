...
description: "Carbon accounting in Sweden: CSRD requirements for Swedish businesses, how Sweden's near-zero-carbon electricity grid shapes Scope 2 reporting, and what companies must disclose under ESRS."
date: "2026-03-29"
author: "Greenio"
level: 2
...
CSRD requires alignment with [GHG Protocol](https://ghgprotocol.org/corporate-standard) Corporate Accounting and Reporting Standard for Scope 1, 2, and 3 emissions. This internationally recognized framework ensures comparability and rigor. Swedish companies should adopt this framework explicitly in hållbarhetsrapporter, noting that compliance with EU standards requires GHG Protocol alignment.
